-- ============================================================================
-- FINANCIAL DASHBOARD: INVENTORY POSITION CARDS
-- ============================================================================
-- Adds 3 new inventory position metrics to financial_dashboard_summary():
--   1. po_unreceived_value  — cost of items on submitted/partially_received POs
--   2. floor_inventory_value — cost of all inventory on floor
--   3. floor_free_value      — cost of uncommitted (not prebooked) inventory
--   4. committed_order_value — cost of confirmed order items not yet delivered
-- ============================================================================
...
COMMENT ON FUNCTION public.financial_dashboard_summary() IS
  ...
  'and inventory position (PO unreceived, floor value, committed orders).';
