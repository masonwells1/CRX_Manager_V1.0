-- Forward-only closeout for the already-applied null-cost workbook follow-up.
-- Fail closed if any stale overload can bypass the reviewed replacement RPCs.
-- This migration changes no data, function body, grant, or feature flag.
