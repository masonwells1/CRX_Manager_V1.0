...
-- 20260914100700_customer_document_bytes_server_only (#764, the restamp of
-- the old 20260914100450, which 20260914100500 stranded) and the commission
-- files 20260914100800 and 100900. Re-read the live ledger by name before
-- applying, and re-derive the high-water from the ledger itself: the snapshot
-- in .claude/session-state/applied-migrations.json was captured 2026-09-05 and
-- does not contain this cohort.
--
