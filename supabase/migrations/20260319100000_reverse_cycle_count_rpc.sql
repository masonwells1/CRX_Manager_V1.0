-- ============================================================================
-- Add reverse_completed_cycle_count() RPC
-- Reverses inventory adjustments made by a completed cycle count,
-- then marks the cycle count as 'cancelled'.
-- ============================================================================

CREATE OR REPLACE FUNCTION reverse_completed_cycle_count(
