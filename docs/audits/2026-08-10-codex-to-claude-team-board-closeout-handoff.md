...
**Repo:** `C:\Users\mason\.codex\worktrees\e652\CRX_Manager`
...
| `pending_commission_snapshot_reconcile` smoke | NOT RUN | Correctly pending until the migration is live. Expected terminal result is exactly `SMOKE_PASS_ROLLBACK`. |
...
- `supabase/migrations/20260810183629_reconcile_pending_commission_snapshots.sql` - exact forward-only repair to verify and apply.
...
- `docs/reference/migration-history.md` - row 866 records that the migration is reviewed but not applied.
