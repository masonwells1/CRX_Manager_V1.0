...
| `splits-shares-allocation` | order_item_field_allocations, create_split_invoices_from_order, dormant shares subsystems, allocate_payment, write-offs | hunted ×2 (c5/c10) — c5: 2 new (update_allocation_set no-sum LOW/dead; field-app acre-rounding LOW) + 2 refuted. c10: 0 new (only transfer_job_to_invoice re-confirms surfaced under this dimension). 1 dry pass; 1 more to drain |
