...
| `commissions` | commission_split, per-order records, recompute-on-edit, commission_payments batch | **DRAINED** (c4 + c7) — c7 confirming pass surfaced 0 new (only re-confirm of the c4 recompute-rounding item) |
