...
Every figure below is relative to **`origin/main` at `ec90015d00e10dc099e69419e4da330d4b9bb4ed`**.

This matters as much as the branch tip OIDs. `main` moves, and when it does the comparison
changes underneath a branch that never moved at all. This report was re-measured after `main`
advanced to the commit above. Every branch's *Behind* count rose by 2, and seven branches
changed their unique-content figures without a single commit being pushed to any of them:
`claude/pr364-guard-commits-local-20260831`, `claude/crx-manager-cleanup-5da404`,
`claude/harness-guardrail-review-bee189`, `claude/optimize-claude-md-79f8ad`,
`codex/pr509-source-recognition-fix-v2-20260830`, and both
`dependabot/github_actions/*` branches.

The Dependabot pair is the clearest illustration. `ec90015d` deleted
`.github/workflows/production-migration.yml` and `production-approval-canary.yml`. Both
branches bump an action version *inside* those files, so what was a modification of a file
`main` has is now the addition of a file `main` lacks. Their content did not change; the
...
|---|---|---|---|---|---|---|---|---|
| `codex/section1-security-hardening-20260725` | `53f6177eb6af` | 16 | 4 | 12 | 1 |  | 601 | no PR in scanned window |
| `chore/migration-ledger-reconcile-20260729` | `65716b1c2d91` | 6 | 0 | 6 |  |  | 556 | PR #275 closed unmerged |
| `codex/idempotency-reset-order-hardening-20260802` | `9049efc80e3e` | 26 | 2 | 24 |  |  | 487 | no PR in scanned window |
| `codex/section4-lifecycle-20260805` | `99cfcff5825e` | 11 | 0 | 11 |  |  | 440 | PR #321 closed unmerged |
| `claude/log-session-attribution-fix` | `f9f5e5642b30` | 1 | 1 | 0 |  |  | 436 | PR #317 merged |
| `claude/push-guard-fix-rescue-e3320d` | `300206b9c113` | 4 | 0 | 4 |  |  | 433 | no PR in scanned window |
| `claude/rescue-unique-docs-20260807` | `bad8c8dbe4de` | 10 | 9 | 1 |  |  | 433 | no PR in scanned window |
| `claude/ordering-cycle-review-t41vat-local-20260831` | `8fc8d81460e3` | 2 | 0 | 2 |  |  | 353 | no PR in scanned window |
| `claude/return-credit-cogs-reversal` | `c4e83dea632b` | 4 | 1 | 3 | 1 |  | 355 | **open PR #361** |
| `claude/ordering-cycle-review-t41vat` | `992ee0888176` | 2 | 0 | 2 |  |  | 351 | PR #356 merged; PR #363 closed unmerged |
| `claude/pricing-audit-strategy-jym8rr` | `f4eaa8259834` | 31 | 8 | 23 | 2 |  | 355 | PR #350 closed unmerged |
| `claude/wave-a-migrations-857dcd` | `3bfd6271caae` | 8 | 4 | 4 | 4 |  | 290 | no PR in scanned window |
| `codex/harden-actor-binding-sql-reader` | `e652f7232da2` | 7 | 4 | 3 | 3 |  | 290 | PR #373 closed unmerged |
| `claude/recover-applied-migrations-20260812` | `27817c2a5329` | 28 | 6 | 22 | 5 | 2 | 287 | PR #395 closed unmerged |
| `claude/restrict-draw-down-owner` | `13e4c7b14f38` | 14 | 4 | 10 | 1 |  | 284 | no PR in scanned window |
| `codex/pr389-coderabbit-fixes` | `203a4742a9c2` | 96 | 37 | 59 | 7 | 1 | 280 | PR #397 closed unmerged |
| `codex/sol-gate-recovery-exception` | `9817fb9e058a` | 13 | 1 | 12 |  |  | 280 | PR #403 closed unmerged |
| `claude/blend-unit-rebuild-step1` | `91051d74ecb3` | 7 | 0 | 7 |  |  | 205 | no PR in scanned window |
| `claude/draw-down-price-tier-lines` | `b4c80b37c2a4` | 16 | 0 | 16 |  | 1 | 214 | PR #404 merged |
| `claude/zealous-agnesi-aa7423` | `4347e4566435` | 12 | 2 | 10 |  |  | 212 | no PR in scanned window |
| `claude/zen-easley-7d771d` | `23343e15409c` | 5 | 0 | 5 |  |  | 207 | no PR in scanned window |
| `codex/fleet-scan-parked-state` | `6f766135fddb` | 5 | 0 | 5 |  |  | 178 | no PR in scanned window |
| `pr435-work` | `0f095b81efe5` | 0 | 0 | 0 |  |  | 162 | no PR in scanned window |
| `claude/coderabbit-setup-optimize-0f308d` | `5b58e3524aa4` | 13 | 3 | 10 |  |  | 104 | PR #441 closed unmerged |
| `claude/codex-guard-single-ampersand` | `dddc6d74820a` | 4 | 0 | 4 |  |  | 89 | PR #464 closed unmerged |
| `claude/codex-recursion-hard-guard` | `47820dff7ed6` | 15 | 10 | 5 |  |  | 104 | PR #452 closed unmerged |
| `claude/push-guard-git-resolution` | `62d22b6e9de2` | 8 | 0 | 8 |  |  | 100 | PR #445 closed unmerged |
| `codex/proof-wrapper-trusted-git-bootstrap` | `a2e1d0a18369` | 3 | 0 | 3 |  |  | 104 | PR #454 closed unmerged |
| `fix/quote-fixture-stale-date` | `be5df11c5daf` | 1 | 0 | 1 |  |  | 87 | PR #468 closed unmerged |
| `claude/codex-claude-cogs-handoff-7bde15` | `e3c4a3fc47df` | 4 | 2 | 2 |  |  | 79 | no PR in scanned window |
| `claude/control-file-coverage-a41c` | `b985e919bef5` | 2 | 0 | 2 |  |  | 73 | no PR in scanned window |
| `claude/guard-content-scan-and-savegate-flake` | `480dc106ef7b` | 7 | 0 | 7 |  |  | 73 | no PR in scanned window |
| `claude/pr401-proof` | `9b2d86a5401a` | 14 | 1 | 13 | 1 |  | 79 | no PR in scanned window |
| `claude/session-orchestration-setup-d73e6c` | `238d242ea87f` | 42 | 19 | 23 |  |  | 79 | **open PR #364** |
| `codex/bootstrap-raw-patch-guard-20260825` | `fe73022380ed` | 2 | 0 | 2 |  |  | 80 | no PR in scanned window |
| `codex/pr402-review-gaps-20260819` | `8811927fff8d` | 25 | 7 | 18 |  |  | 82 | PR #432 closed unmerged |
| `claude/changelog-docs-honesty` | `cc8eed92c508` | 3 | 1 | 2 |  |  | 59 | PR #505 closed unmerged |
| `claude/comment-fix-applied-closeout` | `01660702bca6` | 4 | 0 | 4 |  |  | 58 | PR #501 closed unmerged |
| `claude/hold-latch-cross-session-envelope` | `c903bda704a5` | 7 | 0 | 7 |  |  | 61 | no PR in scanned window |
| `claude/jobdetail-savegate-flake` | `60700533eb38` | 0 | 0 | 0 |  |  | 67 | PR #485 merged |
| `claude/offline-review-stale-snapshot` | `5c2c129d431c` | 1 | 0 | 1 |  |  | 65 | no PR in scanned window |
| `claude/pr364-guard-commits-local-20260831` | `57d27e79105b` | 45 | 19 | 26 |  |  | 70 | no PR in scanned window |
| `claude/pr401-quote-version-trust-8e3db6` | `510a16121e6c` | 18 | 1 | 17 | 1 |  | 63 | no PR in scanned window |
| `claude/remove-guard-hooks-f23691` | `0ac235d0e50e` | 4 | 1 | 3 |  |  | 58 | PR #503 closed unmerged |
| `claude/xenodochial-dubinsky-b55362` | `b7e847d98ccd` | 11 | 0 | 11 |  |  | 65 | PR #493 merged |
| `codex/actor-binding-mixed-notation-repair-20260810` | `5cd3d379da4f` | 12 | 3 | 9 |  |  | 70 | **open PR #449** |
| `codex/section9-ap-safety-remediation` | `0f8bf3aad7f0` | 27 | 6 | 21 | 2 |  | 65 | PR #491 closed unmerged |
| `claude/product-plan-rev12-followup` | `74ccba0f7888` | 3 | 1 | 2 |  |  | 55 | PR #507 closed unmerged |
| `codex/section9-ap-safety-remediation-v2` | `4148f335e682` | 45 | 14 | 31 | 2 |  | 55 | **open PR #500** |
| `codex/autonomy-with-hard-boundaries-20260827` | `3accebbef6ab` | 31 | 3 | 28 |  |  | 4 | PR #513 closed unmerged |
...
| `codex/pr509-source-recognition-fix-v2-20260830` | `259856da608f` | 6 | 1 | 5 |  | 2 | 2 | **open PR #517** |
| `dependabot/github_actions/actions/checkout-7.0.1` | `cbf14d3e2af8` | 4 | 2 | 2 |  |  | 3 | **open PR #518** |
| `dependabot/github_actions/actions/setup-node-7.0.0` | `bc8183c9e963` | 3 | 2 | 1 |  |  | 3 | **open PR #519** |
| `dependabot/npm_and_yarn/eslint-10.4.1` | `66103fdbb6ae` | 2 | 0 | 2 |  |  | 3 | **open PR #522** |
| `dependabot/npm_and_yarn/minor-and-patch-7fe11a6bea` | `949a1c5bec62` | 2 | 0 | 2 |  |  | 3 | **open PR #520** |
| `dependabot/npm_and_yarn/react-major-cbee5c902d` | `2da0ec8cbd56` | 2 | 0 | 2 |  |  | 3 | **open PR #521** |
