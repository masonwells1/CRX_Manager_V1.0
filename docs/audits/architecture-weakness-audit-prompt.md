...
> app-workflow-map (`docs/app-workflow-map.html` — currently 101 nodes / 175 edges) and judges each
...
**Mission:** Treat the map's 175 connections + 101 nodes as an exhaustive worklist. For each, ask the
