...
- Focused queue/receipt/sync/panel/office-page/route/idempotency suites passed: 7 files, 81 tests, including a real blocked IndexedDB v1-to-v2 upgrade simulation and offline-only completion timestamps.
