...
Together, a migration that already passed review can be edited afterward to add an unprotected table with a forgeable actor, and **both gates report pass**. This is not hypothetical: `supabase/migrations/20260903150000_job_chemicals_persist_driver.sql` is a pending unapplied migration on `main` as of 2026-09-03. Remediate the two as one change.
