...
- Generated a private 604-row provisional classification manifest: every row remains unresolved and pending owner review; 21 name-only no-return candidates are evidence flags only. The raw snapshot and manifest are excluded from this public repository; only aggregate counts and their verification checksums are published. Manifest SHA-256: `bf85cc649657735fa26ba8c7e753d653c76ba238ce63c7605ce723393ea322c4`. Final exact-SHA Opus and Sol verdicts are external PR evidence and are required before push or acceptance; this changelog does not self-certify them.
