...
## 2026-07-10 — Gauntlet Section 6 HIGH-1 fix: `save_job_applied_record` double-submit dedup (WRITTEN, NOT YET APPLIED — awaiting Mason's OK)
...
**Still needs Mason:** OK to apply the migration live. (The earlier-flagged `20260711000000_a9_close_period_guards` orphan was merged to `main` by its own session mid-run — no longer an open item.)
