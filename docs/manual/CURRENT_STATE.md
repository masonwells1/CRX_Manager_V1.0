...
**Last verified:** 2026-07-20 (feature summary and live migration watermark re-checked through `20260720185135`; the catalog also contains concurrent live migration `20260720181939` / source name `20260720175946_protect_governed_split_edit_and_void_group`, which is not yet on `origin/main`; operational counts remain the dated 2026-07-18 snapshot below)
