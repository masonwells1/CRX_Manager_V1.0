...
**Last verified:** 2026-07-20 (feature summary and live migration watermark re-checked through `20260720211454`; the 24 previously missing live migration sources landed through PR #180, and delivery-signature Storage access is now delivery-path- and actor-scoped for read, write, and delete; operational counts remain the dated 2026-07-18 snapshot below)
