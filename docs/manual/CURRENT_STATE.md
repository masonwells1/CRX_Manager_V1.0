...
**Last verified:** 2026-08-10 — the live ledger high-water was re-read on 2026-08-10 and is now `20260810025159` (`20260810022500_backfill_stale_line_profit`), above `20260810010308` (`20260809154649_active_team_note_assignment_actor`, applied from a concurrent session) and `20260810000427` (`20260809230500_single_canonical_line_profit`). The `fin-money-whole-cents` standing predicate was re-measured live the same day and now reports **38** rows (**35** `order_items.total_price` + **3** `commissions.commission_amount`), down from 49, because the backfill re-wrote 11 sub-cent price rows through the rounding trigger; `order_items.profit` reports **0** sub-cent and **0** stale rows. The section 2 counts table carries its 2026-08-09 re-read; the 2026-08-07 feature/postflight detail below and the deployment log were **not** re-checked on either date.
