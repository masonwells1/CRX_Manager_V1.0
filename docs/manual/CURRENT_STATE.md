...
**Pricing-audit follow-through remains local and unapplied.** The reporting snapshot, immutable quote-cost snapshot, and database-enforced below-cost approval migrations are now re-issued as `20260810180000`–`20260810180002`, above the current live high-water. They must be replayed against the post-`20260810151000` schema and reviewed before any live apply; the earlier PR #350 stamps must not be used.
