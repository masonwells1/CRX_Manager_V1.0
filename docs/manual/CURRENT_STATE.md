...
**Last verified:** 2026-08-11 UTC, post-apply release check. The live ledger has 960 rows and ends at `20260811183437` (`20260811130000_bind_commission_payout_idempotency_to_intent`). Immediately before it, `20260811183317` records the approved Customer 360 migration submitted as `20260811122851_assign_customers_sales_rep`; that RPC is live with one overload, `SECURITY DEFINER`, `search_path=public, pg_temp`, no PUBLIC/anon EXECUTE, and authenticated/service access. The schema registry, generated Supabase types, and live `pg_proc` fixture were genuinely refreshed through the 960-row high-water. Team Board deployment details below remain current; operational counts below remain the separately dated 2026-07-18 snapshot.
