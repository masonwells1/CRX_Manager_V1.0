...
**Last verified:** 2026-08-13 UTC, migration-ledger and registry re-read. The live ledger has 970 rows and ends at `20260813011751`, carrying submitted migration name `20260813070000_pin_return_idempotency_helper_contract`; `.claude/schema-registry.json` was refreshed through that same high-water. This read confirms ledger/registry currency only. The Customer 360 RPC catalog, grant, and behavior observations below remain their independently dated 2026-08-12 evidence; operational counts below remain the separately dated 2026-07-18 snapshot.

**Wave A — six parked migration candidates.** The local files `20260813010000` through `20260813060000` remain **not applied**, confirmed absent from the live ledger by a read-only re-read on 2026-08-13. No statement in this document describes state they created. They are parked drafts and require their normal review, fresh live preflight, and explicit live-apply authorization before any future apply.
