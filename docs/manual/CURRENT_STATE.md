...
**2026-08-09 live re-read.** Live ledger high-water is **`20260809130108`** (`team_note_completion_rpc_and_assignment_notify`), 946 ledger rows — exactly one row above the 2026-08-07 high-water. That migration was applied from a concurrent session and **has no file in this repository**; see the note at the end of `docs/reference/migration-history.md`. The five foundation-ultra-review migrations (history rows 857–861, re-issued forward as `20260809170500`–`20260809170900`) are written and reviewed but **NOT yet applied live**.
