...
**Last verified:** 2026-08-02. Read-only live ledger verification remains 932 rows at high-water `20260731001654` (`20260730233835_ap_period_close_boundary_hardening` in the server ledger; B7-reconciled disk file `20260731001654_ap_period_close_boundary_hardening`). The AP and immediately preceding Quote/Customer proof claims below are unchanged. A newer local migration, `20260802162805_bind_idempotency_to_mutation_intent`, is under review and is **not live**; it must not be counted as production state. Operational counts below remain the separately dated 2026-07-18 snapshot.
