...
**Wave A — six unapplied migration candidates.** This tree carries `20260813015000`, then `20260813020000` through `20260813060000`; all six submitted names are **absent** from the fresh 970-row live ledger. No statement in this document describes state they created. The first candidate was restamped from `20260813010000` after the live ledger advanced to `20260813011751`; the full set still requires fresh exact-byte review and a same-session ledger read before any apply is considered.
