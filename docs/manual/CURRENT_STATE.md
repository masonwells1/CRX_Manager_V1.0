...
**Last verified:** 2026-08-12 UTC, live post-apply recheck. The live migration ledger has 968 rows and high-water `20260812154757` (`20260812115238_repair_historical_order_line_cents`). The four release migrations submitted as `20260812115235`–`20260812115238` are live at assigned versions `20260812145628`, `20260812151606`, `20260812154028`, and `20260812154757`; their B7-renamed repository sources match the live statement byte lengths and SHA-256 values exactly. The schema registry and generated TypeScript database types were regenerated from live after the rollout. The Team Board frontend and database closeout recorded below remain live. Operational counts below remain the separately dated 2026-07-18 snapshot.
