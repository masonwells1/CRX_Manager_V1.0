...
**Last verified: 2026-09-08 against the live ledger (read-only ledger read: 1001 rows,
`max(version)` `20260909023300`, effective high-water
`20260908120000_close_pr535_live_gaps`); the F2 entry retains its separate
