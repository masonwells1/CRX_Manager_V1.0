...
**Last verified: 2026-07-25** (live high-water `20260723193312` — Supplier Pricing Phase 3 Stage A applied and remains dormant: 604 Products unchanged, zero classifications/family rows, and `supplier_cost_basis_enabled=false`; supplier-pricing governed edit/batch paths and `process-document` v19 OCR retirement remain live and proven. The five unrelated Section 9 PO/AP findings remain owned by still-pending/not-live migration `20260722222742`; the still-pending/not-live Section 1 security migration `20260725234503` hardens six number-generator EXECUTE/role gates and `save_field` actor binding. Older open/deferred claims retain their dated evidence below; owner-facing combined list: root `TODO.md`)
