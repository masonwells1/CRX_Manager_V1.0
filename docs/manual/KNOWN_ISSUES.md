...
- **Per-line-item custom split billing (field-app)** — DESIGN SPEC complete + review-hardened; Phase 1
  ...
  exact signed COGS (including durable returns), quote-provenance/unit normalization, missing-cost,
  and legacy-helper trust repairs, but
