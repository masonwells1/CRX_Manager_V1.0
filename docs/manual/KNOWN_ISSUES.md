...
**Last verified: 2026-08-05.** Live ledger high-water is `20260805171334`. The prior payload-blind replay risk for `save_invoice` and `create_quick_delivery` remains fixed live. The Section 2 statement balance-disclosure migration remains live under `20260803221244`. The historical AR report defects are fixed live under `20260805151605`, with the exact-commit-review follow-up under `20260805171334`: AR Aging reconstructs the selected cutoff instead of reusing current mutable balances; Customer Balance Listing includes overdue, excludes unposted, keeps fully paid invoices in cumulative invoiced/paid/count totals, and makes historical execution admin-only. Post-apply catalog, grants, active admin/sales-rep execution, historical role denial, schema-registry refresh, expanded paid-plus-open rollback smoke, and zero-residue checks passed.
