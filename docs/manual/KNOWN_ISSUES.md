...
**Last verified: 2026-07-22** (live high-water `20260722012359` — #117 auto_draft_skipped logging applied; supplier-pricing governed edit/batch paths and `process-document` v19 OCR retirement are live and proven; older open/deferred claims retain their dated evidence below; owner-facing combined list: root `TODO.md`)
