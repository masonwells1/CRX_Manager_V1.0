...
**Last verified: 2026-07-20** (full document re-read; live migration catalog checked through `20260719092832`; statement-opening-balance work remains local-only; older open/deferred claims retain their dated evidence below; owner-facing combined list: root `TODO.md`)
