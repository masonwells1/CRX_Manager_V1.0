...
**Last verified: 2026-07-29** (live post-apply read: **923 ledger rows**, high-water `20260729125314_application_service_cost_exact_text`. The three approved migrations applied in order: `20260729125227_secure_profile_public_directory`, `20260729125251_pin_contact_sync_search_path`, then `20260729125314_application_service_cost_exact_text`. Live postflights passed, including role-impersonation proof that admins receive exact text cents and a sales rep is denied with SQLSTATE 42501. Earlier resolved and deferred claims below remain unchanged.)
