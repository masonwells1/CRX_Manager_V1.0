...
**The three whole-cent migrations are now represented in `main`.** History rows 868–870 (`20260810150000`, `20260810150500`, `20260810151000`; ledger versions `20260810152935`, `20260810154721`, `20260810155629`) are applied live and landed through PR #371. The remaining fractional historical rows described below are still tracked data debt and were not rewritten by that repository closeout.
