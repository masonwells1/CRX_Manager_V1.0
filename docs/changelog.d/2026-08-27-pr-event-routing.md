...
edits, ambiguous edits, unsupported events, and API lookup failures still force complete
CI. Metadata runs also use a separate concurrency lane so they cannot cancel an
