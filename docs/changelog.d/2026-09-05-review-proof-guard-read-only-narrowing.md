...
both narrowings were withdrawn rather than taken to a fourth round. The guard's behaviour on those
two classes is byte-for-byte the base behaviour; every reproduced bypass is a pinned deny case, and
