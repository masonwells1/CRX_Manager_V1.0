...
- This lets the correction guard reconcile the SQL file with migration-history row 917 and prevents the candidate from being mistaken for an applied migration.
