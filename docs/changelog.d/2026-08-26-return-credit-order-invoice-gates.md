...
- Final database proof: nine candidate/compatibility entries, 56 load-bearing proofs, `SMOKE_PASS_ROLLBACK`, and zero residue. No migration was applied to production.
