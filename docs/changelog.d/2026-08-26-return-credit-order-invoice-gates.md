...
- Final database proof: eight candidate/compatibility entries, 50 load-bearing proofs, `SMOKE_PASS_ROLLBACK`, and zero residue. No migration was applied to production.
