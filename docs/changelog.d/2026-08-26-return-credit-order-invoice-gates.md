...
- Final database proof: seven candidate/compatibility entries, 46 load-bearing proofs, `SMOKE_PASS_ROLLBACK`, and zero residue. No migration was applied to production.
