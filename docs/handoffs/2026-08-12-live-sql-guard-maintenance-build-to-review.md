...
- `node scripts/apply-live-testdata-maintenance-20260812.test.mjs` executed 87 classifier assertions
  against the generated module plus 256 counted producer assertions, including cross-platform line-ending
...
- Current recovery proof passed ESLint, TypeScript typecheck, production build, all agent-workflow tests,
  agent health, the focused producer harness (87 classifier and 256 producer assertions), the 355-case
