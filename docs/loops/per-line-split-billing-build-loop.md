...
| 2 — calculator | **IN PROGRESS** | `claude/split-billing-phase2-calculator` / PR #167 | PROOF — Ran: combined exact Phase 1 + relational-guard + Phase 2 migrations verbatim in network-isolated PostgreSQL 17 with rollback-only assertions · Saw: flag OFF delegated unchanged; 50/50, exact 3-way, 1¢, and signed -13→-7/-6 allocations; one final money round after full-precision conversion; exact job-chemical identity/quantity/unit/frozen price for duplicate products; browser job-price tampering ignored; frozen job/invoice service identity enforced; established frozen measure preserved at 1,600 oz × 25¢/oz = 40,000¢; complete job-field-set enforcement; customer-supplied $0; non-job manual/tier and source-season service pricing; per-person override; 100/0 zero row; flat fee; job snapshot/default/fallback; job-field/chemical membership rejection; exact grouped/ungrouped invoice membership and share-item quantity/acres/price/product/service/amount parity; source/header corruption and malformed pre-post state rejected; hashes; Mode A/vector/role rejection; one public preview overload; private calculator browser execution denied; cleanup failure fatal | the exact-SHA review at `cd4c5edb` found browser price/service authority, cross-group invoice wiring, and share/item identity blockers; each reproduced red and is repaired in the current packet. Content-bound migration reruns are CLEAN; exact-SHA Codex and Claude reruns pending | exact reviewed Phase 1 SHA `7cd00757` merged locally; additive guard migration `20260718210500`; flag remains OFF; no live apply; unrelated live quote Q-2026-2059 has a blank commission recipient |
