...
| 2 — calculator | **IN PROGRESS** | `claude/split-billing-phase2-calculator` / PR #167 | PROOF — Ran: combined exact Phase 1 + relational-guard + Phase 2 migrations verbatim in network-isolated PostgreSQL 17 with rollback-only assertions · Saw: flag OFF delegated unchanged; 50/50, exact 3-way, 1¢, and signed -13→-7/-6 allocations; one final money round after full-precision conversion; exact job-chemical identity/quantity/unit/frozen price for duplicate products; established frozen measure preserved at 1,600 oz × 25¢/oz = 40,000¢; complete job-field-set enforcement; customer-supplied $0; non-job manual/tier and source-season service pricing; per-person override; 100/0 zero row; flat fee; job snapshot/default/fallback; job-field/chemical membership rejection; share-customer/item/source/header relational corruption and malformed pre-post state rejected; hashes; Mode A/vector/role rejection; one public preview overload; private calculator browser execution denied | the latest complete exact-branch Codex review found partial-job-field and durable cross-table integrity blockers, both reproduced red and repaired. Its unit-conversion finding was disproved by the current JobDetail/quote-to-job frozen-unit contract; a direct regression now prevents the proposed double-conversion underbill. Final content-bound and exact-SHA Codex reruns plus Claude review pending | exact reviewed Phase 1 SHA `7cd00757` merged locally; additive guard migration `20260718210500`; flag remains OFF; no live apply; unrelated live quote Q-2026-2059 has a blank commission recipient |
