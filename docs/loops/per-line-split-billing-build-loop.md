...
| 2 — calculator | **IN PROGRESS** | `claude/split-billing-phase2-calculator` / PR #167 | PROOF — Ran: re-stamped preflight `20260720230000` + reviewed Phase 1 `20260720231000` + guards `20260720232000` + calculator `20260720233000` verbatim in network-isolated PostgreSQL 17 · Saw: helper ownership collision and enabled flag rejected before clean install; all signed sales/COGS, quote-unit/provenance/coverage, job authority, flat-fee, temp-object, membership, header, history, and calculator cases green | prior exact-SHA findings reproduced and repaired; fresh content-bound and exact-HEAD Codex + Claude reviews required on merged/re-stamped chain before push | flag OFF; no live apply; §6.1 baseline unmet; re-check live high-water at apply |
