...
| 2 — calculator | **IN PROGRESS** | `claude/split-billing-phase2-calculator` / PR #167 | PROOF — Ran: combined exact Phase 1 + Phase 2 migrations verbatim in network-isolated PostgreSQL 17 with rollback-only assertions · Saw: flag OFF delegated unchanged; 50/50, exact 3-way, 1¢, and signed -13→-7/-6 allocations; one final money round after full-precision conversion; manual/quote/tier/service price precedence; per-person override; 100/0 zero row; flat fee; job snapshot/default/fallback; hashes; Mode A/vector/role rejection; one public preview overload; private calculator browser execution denied | exact-hash Codex + Claude reviews pending | exact reviewed Phase 1 SHA `7cd00757` merged locally; flag remains OFF; no live apply; unrelated live quote Q-2026-2059 has a blank commission recipient |
