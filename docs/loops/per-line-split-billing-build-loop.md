...
| 2 — calculator | **IN PROGRESS** | `claude/split-billing-phase2-calculator` / PR #167 | PROOF — Ran: combined exact preflight + Phase 1 + relational-guard + Phase 2 migrations verbatim in network-isolated PostgreSQL 17 with rollback-only assertions · Saw: stale feature objects and a stale enabled flag rejected before install; flag OFF delegated unchanged; owner/outsider sales-rep job/invoice/field scope, exact null-safe invoice/job binding, and direct-invoice field binding; 50/50, exact 3-way, 1¢, and signed -13→-7/-6 allocations; one final money round after full-precision conversion; exact job-chemical identity/quantity/unit/frozen price/COGS for duplicate products; browser job-price tampering ignored; nullable/negative frozen prices rejected; complete durable job-chemical/service source sets and exact job/invoice service identity; established frozen measure preserved at 1,600 oz × 25¢/oz = 40,000¢; complete job-field-set enforcement; customer-supplied $0/COGS; non-job manual→unambiguous quote→tier with conflicting quotes rejected; source-season service pricing; per-person override; 100/0 zero row; flat-fee calculator JSON persisted exactly with production-shaped non-null quantity 1 per child and tamper rejection; job snapshot/default/fallback; job-field/chemical membership rejection; exact grouped/ungrouped invoice membership and share-item quantity/acres/price/product/service/unit/COGS/amount plus header-cost parity; posted item/source mutation rejected and immutable history retains both source and item identity/unit/COGS; zero-sendable post rejected while suppressed-zero posts and snapshots; source/header corruption and malformed pre-post state rejected; canonical hashes bind product/service identity, price provenance, override modes, and reasons; Mode A/vector/role rejection; one public preview overload; private calculator browser execution denied; cleanup failure fatal | exact-SHA review at `f105ab2b` found SECDEF scope, null-job rebinding, quote precedence, and audit identity; all repaired. Exact-SHA review at `64766630` then found omitted durable job charges and nullable flat-fee quantities; both reproduced red and repaired. Fresh content-bound and exact-SHA reruns pending; Claude remains pending | exact reviewed Phase 1 SHA `7cd00757` remains byte-stable; additive preflight `20260718205500` and guard `20260718210500`; flag remains OFF; no live apply; unrelated live quote Q-2026-2059 has a blank commission recipient |
