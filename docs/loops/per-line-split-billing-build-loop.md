...
| 3 — save/post RPC | **PARKED (fresh-cycle review cap; draft PR #181)** | `codex/per-line-split-billing-phase3-rpc` / PR #181 | PROOF — Ran: Phase 1 + guards + Phase 2 + Phase 3 verbatim in network-isolated PostgreSQL 17 · Saw: calculator cases remained green; ordinary drafts refused unchanged; 100/0 save produced two invoices/items/shares; draft group edit rebuilt dependency-first; actor/group-bound replay and authorization, conflict, header mismatch, zero suppression, post snapshot, and transfer gates green; full pipeline 3,659 passed / 117 skipped before latest repair | Fresh cycle round 1 fixed partial-group authority; round 2 CLEAN at `93954135`; exact docs-head round 3 found ungrouped→group stale-header and source-season defects. Both repaired; a new certification cycle is required before another push | flag OFF; no live apply; PR #181 does not yet contain the final parked repair; Phase 4 waits for Phase 3 certification |
