...
| 2 — calculator | **IN PROGRESS** | `claude/split-billing-phase2-calculator` / PR #167 | PROOF — Ran: combined exact Phase 1 + Phase 2 migrations verbatim in network-isolated PostgreSQL 17 with rollback-only assertions · Saw: flag OFF delegated unchanged; 50/50, exact 3-way, 1¢, and signed -13→-7/-6 allocations; one final money round after full-precision conversion; exact job-chemical identity/quantity/frozen price for duplicate products; customer-supplied $0; non-job manual/tier and source-season service pricing; per-person override; 100/0 zero row; flat fee; job snapshot/default/fallback; job-field/chemical membership rejection; hashes; Mode A/vector/role rejection; one public preview overload; private calculator browser execution denied | prior content-bound reviewers were CLEAN before the latest bytes; complete exact-SHA Codex review then found three job-source/duplicate-product/season blockers, all reproduced red and repaired locally; final content-bound and exact-SHA Codex reruns plus Claude review pending | exact reviewed Phase 1 SHA `7cd00757` merged locally; flag remains OFF; no live apply; unrelated live quote Q-2026-2059 has a blank commission recipient |
