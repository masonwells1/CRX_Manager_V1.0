...
| 3 — save/post RPC | **IN REVIEW (fresh cycle)** | `codex/per-line-split-billing-phase3-rpc` | PROOF — Ran: Phase 1 + guards + Phase 2 + Phase 3 verbatim in network-isolated PostgreSQL 17 · Saw: calculator cases remained green; ordinary drafts refused unchanged; 100/0 save produced two invoices/items/shares; draft group edit rebuilt dependency-first; actor-bound replay/conflict/header mismatch/zero suppression/post snapshot/transfer gates green; full pipeline 3,659 passed / 117 skipped before latest repair | First cycle fixed deletion order, cross-actor replay, and ordinary-draft adoption. Fresh review round 1 found partial-group sales-rep authority; fixed with an all-current-children authorization guard and rollback regression; certification pending | flag OFF; no live apply; Phase 4 waits for Phase 3 certification; drift review HIGHs remain intentionally absent prerequisites and deferred apply-time high-water proof |
