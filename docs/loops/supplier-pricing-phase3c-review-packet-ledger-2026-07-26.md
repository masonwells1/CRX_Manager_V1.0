...
- Current publication-reconciliation base and one-time CI bootstrap pin:
  `d3bac970804bf6130b6bf6259eed05fad0367a9c` (#248 docs-only reconciliation;
...
`07a3d4833cf8517ea53831a6ff0976b4a6c4c67f`. Current #248 reconciliation merged
...
Exact object checks confirm this current base also lacks both guard files, so
the active one-time CI bootstrap pin is now exactly
`d3bac970804bf6130b6bf6259eed05fad0367a9c`.
...
- Historical #245 branch reconciliation was superseded by the current #247
  ...
  `07a3d4833cf8517ea53831a6ff0976b4a6c4c67f`. The current #248 docs-only base
  and active bootstrap pin are `d3bac970804bf6130b6bf6259eed05fad0367a9c`.
