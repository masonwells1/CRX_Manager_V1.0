...
| 1.G phase gate (Sol → PR → merge → live smoke) | orchestrator | GATE | — | Sol round 1 BLOCK (2 HIGH + 3 MED, all fixed incl. atomic-promotion RPC through full migration gauntlet); rebased onto origin/main (9 ahead, clean); Sol round-2 verdict in flight |
