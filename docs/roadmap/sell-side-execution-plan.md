...
- 🔄 **UI consolidation (frontend, in progress):**
  ...
  - ⏭ **Remaining UI:** Orders nav `needs_pricing` count badge; rep notification on rush-order creation (`notificationTriggers`).
