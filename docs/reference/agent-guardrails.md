...
Ordinary migration SQL may not create, alter, or drop an event trigger, or create, replace, alter,
or drop any enabled captured event-trigger routine. That second check binds the routine's exact
