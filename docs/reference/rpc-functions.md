...
Migration `20260714024811_offline_action_receipts.sql` adds three callable RPCs after the live 306-function baseline above; they are deliberately not included in that live count until the migration is applied and re-introspected.
