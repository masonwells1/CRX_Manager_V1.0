...
- Cancelled whole-conversion quotes - Live escape-hatch behavior remains permissive until prepared migration `20260718193000` is applied. The prepared contract blocks reopening when delivered or posted/paid downstream activity survives and retires the unused `restore_cancelled_order` status-only RPC, whose historical body did not reconstruct cancellation's inventory or financial effects.
