...
- `commission_earned_state_ledger` - **LOCAL CANDIDATE `20260903150100`, NOT LIVE:** append-only bigint-cent snapshots of each commission's report-relevant state, with real transaction-time revisions, stable recipient/source/customer labels, RLS, RESTRICT lineage, and mutation/truncate refusal triggers.
