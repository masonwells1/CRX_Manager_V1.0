...
### Current State
- The current E2E suite is the set of Playwright `*.spec.ts` files under `e2e/`; derive the count from the checkout instead of copying a volatile number from an agent instruction file.
