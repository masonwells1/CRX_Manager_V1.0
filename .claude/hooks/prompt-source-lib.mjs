...
export const PUSH_POLICY =
  "PUSH POLICY: Mason authorized AUTO-PUSH to main (2026-06-16) — push regular code once the pipeline is green (review clean + tests + the pre-push hook's typecheck/build); no approval click; Vercel rollback is one click. HARD GATES that ALWAYS need Mason's explicit OK in the current conversation: applying a live migration, deploying an edge function, deleting data. Never commit unrelated files.";
