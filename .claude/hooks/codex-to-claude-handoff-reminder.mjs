...
emit([
  ...
  "",
  "Default path:",
  "- For direct review, read .claude/commands/claude-review.md (in the repository root) and run node scripts/run-claude-review.mjs.",
  "- Reconcile Claude's findings as agree / disagree / needs more evidence.",
  "",
  "Fallback / continuation path:",
  "- If the Claude CLI is unavailable, Mason wants a separate Claude session to continue, or a durable packet is the deliverable, read .claude/commands/codex-to-claude-handoff.md.",
  "- Create a packet at docs/audits/<YYYY-MM-DD>-codex-to-claude-<slug>-handoff.md.",
  "- Tell Mason exactly: Open Claude in the CRX Manager folder and say: \"Read <handoff-path> and follow it.\"",
  "",
  PUSH_POLICY,
  "",
  "Sources of truth: .claude/commands/claude-review.md and .claude/commands/codex-to-claude-handoff.md",
].join("\n"));
