...
const rules = [
  ...
  },
  {
    ...
    alternatives: "Route the work through /ship — it reviews, tests, and lands green regular code through a PR (never a direct push to main), and still STOPS for Mason's explicit OK at every hard gate listed in AGENTS.md (see the LANDING POLICY above)."
  },
  {
