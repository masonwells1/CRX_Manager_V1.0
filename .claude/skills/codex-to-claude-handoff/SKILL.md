...
description: Use when Mason asks Codex to create a durable handoff packet, context file, continuation task, or fallback review packet for Claude in CRX Manager.
---

# Codex To Claude Handoff

Read `C:\CRX_Manager\.claude\commands\codex-to-claude-handoff.md` completely and use it as the source of truth.
...
Adapt Claude-specific wording to Codex tools when running from Codex. Write the handoff packet in the current thread unless Mason explicitly asks for a different destination.
