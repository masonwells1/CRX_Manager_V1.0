...
In summary, that prompt makes you walk the map's ~101 nodes + ~175 connections as a worklist and run **7 weakness passes** against the live DB (project `rhyzpcqhnizqbxphqdkr`) + `src/`:
