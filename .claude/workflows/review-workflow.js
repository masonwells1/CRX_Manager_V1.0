...
const LAYERS = [
  ...
  },
  {
    ...
    prompt:
      ...
      `- Money: no binary-float conversion, parsing, arithmetic, or rounding; new storage uses bigint cents; documented legacy PostgreSQL numeric-dollar columns retain exact numeric math and finite whole-cent constraints once clean.\n` +
