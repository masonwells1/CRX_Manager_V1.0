...
`], {
  ...
  await assert.rejects(() => checkGitHubEventPrivateArtifactContainment({ root: invalidUtf8Repo, environment: { GITHUB_EVENT_NAME: 'pull_request_target', GITHUB_EVENT_PATH: invalidUtf8TargetEvent } }), /invalid UTF-8 candidate commit tree path/);
