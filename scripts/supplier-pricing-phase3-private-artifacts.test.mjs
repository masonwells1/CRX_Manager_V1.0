...
try {
  ...
  assert(containmentJob.includes("phase3_bootstrap_base='3ca289c5c5b91c800a350ab828a6000bd3d399e6'"));
  ...
  if (fixtureBash()) {
    ...
    const simulatedBootstrapShell = containmentShell.replace("phase3_bootstrap_base='3ca289c5c5b91c800a350ab828a6000bd3d399e6'", `phase3_bootstrap_base='${bootstrapBase}'`);
