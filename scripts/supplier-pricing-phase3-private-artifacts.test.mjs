...
try {
  ...
  assert(containmentJob.includes("phase3_bootstrap_base='26a5f88b960fe477b334ae4101c67dc0b21fca3c'"));
  ...
  if (fixtureBash()) {
    ...
    const simulatedBootstrapShell = containmentShell.replace("phase3_bootstrap_base='26a5f88b960fe477b334ae4101c67dc0b21fca3c'", `phase3_bootstrap_base='${bootstrapBase}'`);
