...
try {
  ...
  for (const bytes of [utf32(utf16Json, 'le', { bom: true }), utf32(utf16Json, 'be', { bom: true }), utf32(utf16Json, 'le'), utf32(utf16Json, 'be')]) assert.equal(structuralPrivateArtifactReason(bytes), 'approved private JSON format structure');
