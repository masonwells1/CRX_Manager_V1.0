...
`], {
  ...
  assert(containmentJob.includes("phase3_bootstrap_base='dd33f162365913867ff3aefd0b7e540a531d102f'"));
  ...
  if (fixtureBash()) {
    ...
    const simulatedBootstrapShell = containmentShell.replace("phase3_bootstrap_base='dd33f162365913867ff3aefd0b7e540a531d102f'", `phase3_bootstrap_base='${bootstrapBase}'`);
