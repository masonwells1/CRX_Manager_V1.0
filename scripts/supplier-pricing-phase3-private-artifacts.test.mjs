...
`], {
  ...
  assert(containmentJob.includes("phase3_bootstrap_base='2a9e9252a62642e51b71c248c8c2f149a9a434d9'"));
  ...
  if (fixtureBash()) {
    ...
    const simulatedBootstrapShell = containmentShell.replace("phase3_bootstrap_base='2a9e9252a62642e51b71c248c8c2f149a9a434d9'", `phase3_bootstrap_base='${bootstrapBase}'`);
