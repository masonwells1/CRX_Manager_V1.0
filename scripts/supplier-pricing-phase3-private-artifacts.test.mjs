...
try {
  ...
  await assert.rejects(() => checkPrePushPrivateArtifactContainment({ root: advertisedRemoteRepo, execute: advertisedRemoteExecute, remoteName: 'origin', stdin: `refs/heads/packet ${advertisedRemoteHead} refs/heads/packet ${'0'.repeat(40)}\n` }), /private-after-remote\.json .*private JSON format marker in malformed candidate/);
