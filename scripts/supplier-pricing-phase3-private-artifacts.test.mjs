...
`], {
  ...
  assert(containmentJob.includes("phase3_bootstrap_base='d787b7e0e1c9cb5eb85c86b448e68b1ca43fce9c'"));
  ...
  if (fixtureBash()) {
    ...
    const simulatedBootstrapShell = containmentShell.replace("phase3_bootstrap_base='d787b7e0e1c9cb5eb85c86b448e68b1ca43fce9c'", `phase3_bootstrap_base='${bootstrapBase}'`);
