...
BEGIN
  ...
  EXCEPTION WHEN OTHERS THEN IF SQLERRM LIKE 'SMOKE_FAIL:%' THEN RAISE; END IF; IF SQLERRM NOT LIKE 'ADMIN_OR_SALES_REQUIRED%' THEN RAISE EXCEPTION 'SMOKE_FAIL: get import role got %', SQLERRM; END IF; END;
  ...
  EXCEPTION WHEN OTHERS THEN IF SQLERRM LIKE 'SMOKE_FAIL:%' THEN RAISE; END IF; IF SQLERRM NOT LIKE 'ADMIN_OR_SALES_REQUIRED%' THEN RAISE EXCEPTION 'SMOKE_FAIL: workspace role got %', SQLERRM; END IF; END;
  BEGIN PERFORM public.get_supplier_market_evidence(ARRAY[v_product]); RAISE EXCEPTION 'SMOKE_FAIL: market wrong-role allowed';
  EXCEPTION WHEN OTHERS THEN IF SQLERRM LIKE 'SMOKE_FAIL:%' THEN RAISE; END IF; IF SQLERRM NOT LIKE 'ADMIN_OR_SALES_REQUIRED%' THEN RAISE EXCEPTION 'SMOKE_FAIL: market role got %', SQLERRM; END IF; END;
  BEGIN PERFORM public.get_supplier_quote_sheet(v_vendor); RAISE EXCEPTION 'SMOKE_FAIL: quote wrong-role allowed';
  EXCEPTION WHEN OTHERS THEN IF SQLERRM LIKE 'SMOKE_FAIL:%' THEN RAISE; END IF; IF SQLERRM NOT LIKE 'ADMIN_OR_SALES_REQUIRED%' THEN RAISE EXCEPTION 'SMOKE_FAIL: quote role got %', SQLERRM; END IF; END;
  BEGIN PERFORM public.get_product_price_history(v_product); RAISE EXCEPTION 'SMOKE_FAIL: history wrong-role allowed';
  EXCEPTION WHEN OTHERS THEN IF SQLERRM LIKE 'SMOKE_FAIL:%' THEN RAISE; END IF; IF SQLERRM NOT LIKE 'ADMIN_OR_SALES_REQUIRED%' THEN RAISE EXCEPTION 'SMOKE_FAIL: history role got %', SQLERRM; END IF; END;
