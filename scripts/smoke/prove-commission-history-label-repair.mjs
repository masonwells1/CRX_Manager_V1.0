...
const REPLAY_GUARD = path.join(ROOT, 'supabase', 'migrations', '20260914100200_commission_history_report_replay_guard.sql');
// Renumbered 20260905020100 -> 20260905190000 -> 20260905210000 -> 20260914100900 so it runs LAST in the ordered plan;
...
const REPAIR = path.join(ROOT, 'supabase', 'migrations', '20260914100900_repair_commission_history_label_snapshots.sql');
const RECIPIENT_GUARD = path.join(ROOT, 'supabase', 'migrations', '20260914100300_refuse_stale_commission_payment_recipient.sql');
const BUSINESS_DATE_GUARD = path.join(ROOT, 'supabase', 'migrations', '20260914100400_enforce_commission_payment_business_date.sql');
