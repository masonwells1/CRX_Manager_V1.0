...
// Renumbered 20260905020100 -> 20260905190000 -> 20260905210000 -> 20260908130000 so it runs LAST in the ordered plan;
...
const REPAIR = path.join(ROOT, 'supabase', 'migrations', '20260908130000_repair_commission_history_label_snapshots.sql');
