...
export function validateReviewInputs({ expectedCommit, reviewedCommit, migrationName, queryHash, reviewProofHash }) {
  ...
  if (!SHA256_RE.test(String(reviewProofHash))) throw new Error("review proof hash must be lowercase SHA-256");
}
