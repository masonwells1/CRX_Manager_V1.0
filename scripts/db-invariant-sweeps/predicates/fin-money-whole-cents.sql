...
--
--   Migration 20260808150400 installs BEFORE-write triggers that round every
...
--   are recorded at the bottom of migration 20260808150400.
--
...
--
-- SCHEMA FACTS (verified live 2026-08-08 against rhyzpcqhnizqbxphqdkr)
--   order_items(id, order_id, product_id, total_price numeric,
--               quantity_remaining numeric, is_generated = NEVER on all four)
--   commissions(id, order_id, commission_amount numeric, status, deleted_at)
