...
- 66 pages, **96** tables (+2 views; incl. `quote_product_draws`), **219** RPCs (+= `assign_job_applicator`), **441 migrations** (439 live + 2 pending FILE-ONLY: re-homed planned-holds `20260613150000` + sell-side #5 auto-expire `20260613160000`), 7 Edge Functions (+ `_shared` lib dir)
