...
- 66 pages, **95** tables (+2 views; incl. `rebate_claim_counters`), **218** RPCs (live non-trigger count; += `assign_job_applicator` 2026-06-10), **408 migrations**, 7 Edge Functions (+ `_shared` lib dir)
