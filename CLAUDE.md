...
- 66 pages, **96** tables (+2 views; incl. `quote_product_draws`), **219** RPCs (+= `assign_job_applicator`), **440 migrations** (439 live + 1 pending: re-homed planned-holds `20260613150000`), 7 Edge Functions (+ `_shared` lib dir)
