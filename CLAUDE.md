...
- 66 pages, **96** tables (+2 views; incl. `quote_product_draws`), **219** RPCs (+= `assign_job_applicator`), **441 migrations** (439 live + 2 pending: re-homed planned-holds `20260613150000` + cancel_order hold-resync on draw-cancel `20260613150100`), 7 Edge Functions (+ `_shared` lib dir)
