...
- 66 pages, **96** tables (+2 views; incl. `quote_product_draws`), **219** RPCs (+= `assign_job_applicator`), **442 migrations** (439 live + 3 pending FILE-ONLY: re-homed planned-holds `20260613150000` + sell-side #5 auto-expire `20260613160000` + #2 v1a pricing-gate `20260613170000`), 7 Edge Functions (+ `_shared` lib dir)
