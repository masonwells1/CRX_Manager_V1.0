...
**Live counts — verify with `node scripts/check-doc-drift.mjs`, don't trust them blind:** 79 pages · 111 tables (+2 views) · 270 callable RPCs (+56 trigger fns) · **561 migrations** on disk · 6 Edge Functions · ~2,222 unit tests + 115 skipped / 94 E2E specs. *(2026-06-30: the codex-driven-bug-hunt's 11 findings are now APPLIED LIVE — 5 HIGHs + 5 MEDs as migrations `parked_001`–`parked_010`, plus the PARKED-011 edge-fn fix deployed to `process-document` v14. The 5 MED migration files `parked_002/005/006/008/010` are recorded here; the 5 HIGH files live on the `feat/fieldapp-beyond-parity` branch.)*
...
| Doc | Contents |
|-----|----------|
| `docs/reference/database-schema.md` | 111 tables (+2 views) + RLS matrix |
| `docs/reference/rpc-functions.md` | 270 callable RPCs + 56 trigger functions |
| `docs/reference/migration-history.md` | 561 migrations |
| `docs/reference/pages-routes.md` | 79 pages with routes |
