...
- 66 pages, **96** tables (+2 views; incl. `quote_product_draws`), **219** RPCs (+= `assign_job_applicator`), **442 migrations** (439 live + 3 pending, apply in stamp order: re-homed planned-holds `20260613150000` → cancel_order hold-resync on draw-cancel `20260613150100` → void_order hold-resync on draw-void `20260613150200`), 7 Edge Functions (+ `_shared` lib dir)
