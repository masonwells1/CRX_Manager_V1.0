...
- 66 pages, **95** tables (+2 views; incl. `rebate_claim_counters`), **218** RPCs, **373 migrations**, 7 Edge Functions (+ `_shared` lib dir)
...
| `docs/reference/migration-history.md` | 373 migrations |
