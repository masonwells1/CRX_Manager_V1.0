...
- 66 pages, **96** tables (+2 views; incl. `quote_product_draws`), **219** RPCs, **423 migrations**, 7 Edge Functions (+ `_shared` lib dir)
...
swept in `20260611080937` because this snippet used to omit the filter):
```sql
