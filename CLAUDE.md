...
- 66 pages, **97** tables (incl. `rebate_claim_counters`), **~204** RPCs, **367 migrations** (this branch; a parallel session also advanced main — counts reconcile at merge), 7 Edge Functions (+ `_shared` lib dir)
