...
- 66 pages, **95** tables (+2 views; incl. `rebate_claim_counters`), **217** RPCs (live non-trigger count, verified 2026-06-10; the old 218 predated the `record_payment` drop), **403 migrations**, 7 Edge Functions (+ `_shared` lib dir)
