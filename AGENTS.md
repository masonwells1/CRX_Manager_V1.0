...
- Live counts (regenerated 2026-05-30): 66 lazy-loaded pages, 369 migrations, 7 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-05-30. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
