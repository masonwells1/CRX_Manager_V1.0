...
- Live counts (regenerated 2026-06-17): 68 lazy-loaded pages, 474 migrations, 7 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-06-17. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
