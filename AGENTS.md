...
- Delegate only significant, independent, bounded work whose saved time or reduced context noise exceeds the coordination cost. Keep tiny fixes and tightly sequential work with the coordinator, and never exceed three active workers.
