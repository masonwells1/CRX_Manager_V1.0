...
- Live counts (regenerated 2026-05-08): 65 lazy-loaded pages, 285 migrations, 8 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-05-08. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
