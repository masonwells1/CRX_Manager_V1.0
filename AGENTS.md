...
- Live counts (regenerated 2026-07-04): 82 lazy-loaded pages, 622 migrations, 6 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-07-04. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
