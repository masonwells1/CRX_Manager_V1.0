...
- Live counts (regenerated 2026-05-26): 66 lazy-loaded pages, 356 migrations, 7 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-05-26. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
