...
- Live counts (regenerated 2026-05-25): 66 lazy-loaded pages, 353 migrations, 7 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-05-25. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
