...
- Live counts (regenerated 2026-06-29): 79 lazy-loaded pages, 556 migrations, 6 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-06-29. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
