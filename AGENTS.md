...
- Live counts (regenerated 2026-06-24): 75 lazy-loaded pages, 517 migrations, 6 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-06-24. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
