...
- Live counts (regenerated 2026-05-10): 65 lazy-loaded pages, 291 migrations, 7 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-05-10. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
