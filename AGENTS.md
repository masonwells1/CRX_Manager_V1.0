...
- Live counts (regenerated 2026-06-10): 66 lazy-loaded pages, 408 migrations, 7 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-06-10. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
