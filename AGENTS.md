...
- Live counts (regenerated 2026-05-31): 66 lazy-loaded pages, 369 migrations, 7 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-05-31. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
