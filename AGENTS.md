...
- Live counts (regenerated 2026-05-17): 66 lazy-loaded pages, 345 migrations, 7 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-05-13. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
