...
- Live counts (regenerated 2026-05-12): 66 lazy-loaded pages, 320 migrations, 7 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-05-12. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
