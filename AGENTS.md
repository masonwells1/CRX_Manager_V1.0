...
- Live counts (regenerated 2026-06-11): 66 lazy-loaded pages, 425 migrations, 7 Edge Functions.
...
*Regenerated by `scripts/regenerate-agents-md.mjs` on 2026-06-11. To rebuild: `node scripts/regenerate-agents-md.mjs`.*
