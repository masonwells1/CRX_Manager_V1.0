    ...
    children: [
      { path: 'login', element: <LoginPage /> },
      {
        ...
        children: [
          ...
          { path: 'payments', element: <ProtectedRoute allowedRoles={['admin', 'sales_rep']}><Payments /></ProtectedRoute> },
          { path: 'ar-aging', element: <ProtectedRoute allowedRoles={['admin', 'sales_rep']}><ARaging /></ProtectedRoute> },
          { path: 'compliance', element: <ProtectedRoute allowedRoles={['admin', 'sales_rep']}><Compliance /></ProtectedRoute> },
          { path: 'rebates', element: <ProtectedRoute allowedRoles={['admin', 'sales_rep']}><Rebates /></ProtectedRoute> },
          { path: 'vehicles', element: <ProtectedRoute allowedRoles={['admin', 'sales_rep']}><Vehicles /></ProtectedRoute> },
          { path: 'vehicles/:id', element: <ProtectedRoute allowedRoles={['admin', 'sales_rep']}><VehicleDetail /></ProtectedRoute> },
          { path: 'application-records', element: <ProtectedRoute allowedRoles={['admin', 'sales_rep']}><ApplicationRecords /></ProtectedRoute> },
