    ...
    children: [
      ...
      { path: 'reset-password', element: <ResetPasswordPage /> },
      {
        ...
        children: [{
          ...
          { path: 'orders/new', element: <ProtectedRoute allowedRoles={['admin', 'sales_rep', 'driver', 'applicator']}><NewOrder /></ProtectedRoute> },
          { path: 'orders/:id', element: <ProtectedRoute allowedRoles={['admin', 'sales_rep', 'driver', 'applicator']}><OrderDetail /></ProtectedRoute> },
