...
const navItems: NavItem[] = [
  ...
  { path: '/jobs', label: 'Job Schedule', icon: <CalendarClock className="w-5 h-5" />, roles: ['admin', 'sales_rep', 'applicator'] },
  ...
  { path: '/vehicles', label: 'Vehicles', icon: <Plane className="w-5 h-5" />, roles: ['admin'] },
  ...
  { path: '/application-records', label: 'App Records', icon: <ClipboardCheck className="w-5 h-5" />, roles: ['admin', 'sales_rep', 'applicator'] },
  { path: '/compliance', label: 'Compliance', icon: <ShieldCheck className="w-5 h-5" />, roles: ['admin', 'sales_rep'] },
  { path: '/commission-payments', label: 'Commission Pay', icon: <Banknote className="w-5 h-5" />, roles: ['admin'] },
  { path: '/month-end', label: 'Month-End', icon: <CalendarCheck className="w-5 h-5" />, roles: ['admin'] },
  { path: '/customer-transactions', label: 'Transactions', icon: <CreditCard className="w-5 h-5" />, roles: ['admin'] },
  { path: '/prepayments', label: 'Prepayments', icon: <Wallet className="w-5 h-5" />, roles: ['admin'] },
