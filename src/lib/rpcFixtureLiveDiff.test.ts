...
const QUEUED_MIGRATION_FUNCTIONS: Record<string, string> = {
  ...
  resolve_line_split_vector: '20260720233000_per_line_split_billing_save_rpc.sql',
  save_field_app_split_invoice: '20260720233000_per_line_split_billing_save_rpc.sql',
};
