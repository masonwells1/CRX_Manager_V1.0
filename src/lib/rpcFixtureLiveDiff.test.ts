...
const LIVE_PG_PROC_COUNT = 471; // count(DISTINCT proname); FULL REGEN 2026-07-20 (ledger 20260720181939) = 470, CSV md5 73c1a96b186c9f9efb963886c6ff12b8, PLUS 1 parked pre-registration: reject_supplier_price_import (created by pending migration 20260720230000 — REMOVE from this note and regenerate the snapshot from live pg_proc after it applies). Current CSV md5 25997b9c675874f20c1fa69ad456f0ba. Includes trigger/helper and plpgsql_check extension functions in public.
