...
const LIVE_PG_PROC_COUNT = 515; // count(DISTINCT proname); FULL REGEN 2026-07-22 through live high-water 20260722172533 (commission-recipient + name-reuse guards + field-profitability + inventory-location guard + cost-basis inner); exact CSV from read-only live pg_proc.
