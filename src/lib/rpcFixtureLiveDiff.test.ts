...
// -------------------------------------------------------------------------
// Checked-in live snapshot — verified 2026-08-12, 566 public functions
...
const LIVE_PG_PROC_COUNT = 566; // count(DISTINCT proname); verified unchanged after live high-water 20260812003315 (function-body-only Customer 360 follow-up).
