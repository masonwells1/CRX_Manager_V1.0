...
const LIVE_PG_PROC_COUNT = 470; // count(DISTINCT proname); FULL REGEN 2026-07-20 after governed split edit/group-void correction (ledger 20260720181939); exact CSV md5 73c1a96b186c9f9efb963886c6ff12b8. Includes trigger/helper and plpgsql_check extension functions in public.
