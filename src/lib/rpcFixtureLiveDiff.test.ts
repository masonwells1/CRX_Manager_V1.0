...
const LIVE_PG_PROC_COUNT = 400; // count(DISTINCT proname); FULL REGEN 2026-07-16 via the documented live query (post CRM Phase 1 applies + gauntlet migrations); sha256-verified against live. Includes trigger/helper and plpgsql_check extension functions in public.
