...
// -------------------------------------------------------------------------
// Checked-in live snapshot — fully regenerated 2026-07-29, 546 public functions
...
const LIVE_PG_PROC_COUNT = 546; // count(DISTINCT proname); FULL REGEN 2026-07-29 through live high-water 20260729035923 (application_service_cost_admin_only: +admin_get_application_service_costs, +admin_set_application_service_cost; application_service_atomic_save: +admin_save_application_service; profile/auth work landed by a sibling session: +_guard_last_active_admin, +_sync_auth_access_on_profile_active, +is_active_profile); exact CSV from read-only live pg_proc.
