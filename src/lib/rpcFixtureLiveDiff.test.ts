...
const LIVE_PG_PROC_COUNT = 560; // count(DISTINCT proname); FULL REGEN 2026-08-09 through live high-water 20260809130108 via read-only live pg_proc (+2 since 2026-08-07: complete_team_note and notify_team_note_assignment).
