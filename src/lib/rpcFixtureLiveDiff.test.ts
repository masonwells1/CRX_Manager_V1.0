...
// -------------------------------------------------------------------------
// Checked-in live snapshot — fully regenerated 2026-07-16, 401 public functions
...
const LIVE_PG_PROC_COUNT = 401; // count(DISTINCT proname); FULL REGEN 2026-07-16 from live after CRM Phase 1 + all money/inventory gauntlet migrations, including the delivery replay wrapper.
