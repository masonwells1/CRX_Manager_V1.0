...
// -------------------------------------------------------------------------
// Checked-in live snapshot — fully regenerated 2026-07-22, 507 public functions
...
const LIVE_PG_PROC_COUNT = 507; // count(DISTINCT proname); FULL REGEN 2026-07-22 after live apply through 20260722043537 (null-cost workbook follow-up plus assertion replay). Includes trigger/helper and plpgsql_check extension functions in public.
