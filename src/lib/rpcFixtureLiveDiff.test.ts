...
const LIVE_PG_PROC_COUNT = 267; // count(DISTINCT proname); 265→267 on 2026-06-29 (Wave 2a remediation: added get_jobs_billed_customers (FIX 2, mig 20260629160000) + unpost_invoice_group (FIX 4, mig 20260629170000)); 264→265 on 2026-06-25 (added transfer_invoice_to_job, #27 reverse leg, mig 20260625120000); 265→264 on 2026-06-21 (dropped update_allocation_set); 266→265 on 2026-06-17 (dropped create_invoice_from_delivery)
