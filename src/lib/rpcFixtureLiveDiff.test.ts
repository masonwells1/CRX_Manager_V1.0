...
// -------------------------------------------------------------------------
// Checked-in live snapshot — fully regenerated 2026-08-12, 586 public functions
...
const QUEUED_MIGRATION_FUNCTIONS: Record<string, string> = {
  // (empty — the pricing migrations are live and no queued bridge remains.)
};
