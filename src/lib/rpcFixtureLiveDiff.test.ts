...
const LIVE_PG_PROC_NAMES_CSV =
  '__plpgsql_show_dependency_tb,_batch_apply_prepayments_impl,_bind_completed_lifecycle_idempotency,_calculate_product_pricing,_cancel_order_impl_20260714,_cancel_order_split_provenance_impl_20260719,_check_credit_limit,_claim_bound_lifecycle_idempotency,_close_job_location_dispatch_on_job_terminal,_complete_cycle_count_impl,_complete_delivery_aggregate_impl,_complete_delivery_authorized_impl,_complete_delivery_period_preflight_impl,_create_split_invoices_from_order_provenance_impl_20260719,_delete_invoices_split_provenance_impl_20260719,_enforce_allocation_not_over_payment,_enforce_applicator_license,_enforce_billed_job_applied_record_immutability,_enforce_billed_job_immutability,_enforce_delivery_items_parent_lock,_enforce_delivery_status_transition,_enforce_field_billing_defaults_sum_100,_enforce_invoice_status_transition,_enforce_job_status_transition,_enforce_order_status_transition,_enforce_po_status_transition,_enforce_quote_status_transition,_enforce_quote_terminal_not_drawn,_enforce_return_status_transition,_fill_audit_actor,_format_pricing_dollars,_format_pricing_margin_percent,_get_customer_statement_scoped_impl,_guard_credit_memo_application_immutable,_guard_delivery_delete,_guard_idempotency_key_insert,_guard_inventory_transactions_immutable,_guard_invoice_delete,_guard_offline_action_receipt_insert,_guard_order_delete,_guard_po_delete,_guard_prepay_applications_immutable,_guard_profile_role_lock,_insert_commissions_for_job,_insert_commissions_for_order,_invalidate_deleted_purchase_order_retry_state,_is_admin_override,_is_dispatched_to_me,_issue_return_credit_impl,_mark_delivery_aggregate_short_stock,_parse_pricing_dollars,_parse_pricing_margin_percent,_post_invoice_customer_scope_impl,_post_invoice_group_customer_scope_impl,_post_invoice_impl_20260714,_prebook_quick_delivery_inventory,_preserve_job_location_dispatch_on_field_delete,_purchase_order_item_unit_cost_cents,_receive_return_impl_20260714,_receiving_records_before_delete,_recompute_prepay_credit_balance,_require_auth,_require_bulk_po_content_fingerprint,_reverse_completed_cycle_count_impl,_reverse_credit_memo_application,_save_field_app_invoice_impl_20260714,_save_invoice_governed_split_guard_impl_20260720,_save_invoice_scoped_impl,_save_invoice_split_provenance_impl_20260719,_save_purchase_order_ascii_identity_impl,_save_purchase_order_atomic_number_impl,_save_purchase_order_cost_input_impl,_snapshot_order_item_cost,_split_invoice_content_claim,_sync_job_holds,_sync_job_location_dispatch_on_applicator_change,_sync_job_location_dispatch_on_field_insert,_sync_planned_holds,_sync_quote_job_reservations,_trg_release_job_holds_on_lifecycle,_trg_sync_job_holds,_update_order_items_impl,_validate_order_shares_total,_void_invoice_group_guard_impl_20260720,_void_invoice_split_provenance_impl_20260719,_void_order_impl_20260714,adjust_inventory,admin_update_profile,allocate_payment,apply_credit_memo_to_invoice,apply_prepay_to_invoice,apply_product_pricing_change_set,apply_remaining_prepayments,apply_write_off,approve_return,approve_supplier_price_import,assign_job_applicator,auto_expire_quotes,batch_apply_all_prepayments,batch_apply_prepayments,batch_approve_blend_tickets,batch_cancel_deliveries,batch_post_invoices,batch_reject_blend_tickets,batch_reschedule_deliveries,batch_void_invoices,bulk_create_label_drafts,bulk_import_order,calculate_billing_splits,calculate_prices_from_margin,cancel_cycle_count,cancel_delivery,cancel_order,cancel_purchase_order,cancel_return,check_customer_credit_limit,check_duplicate_blend_ticket,check_duplicate_delivery,check_idempotency,check_period_open,check_rate_limit,check_remainder_reminders,check_unpriced_orders,cleanup_rate_limits,close_accounting_period,close_quote_as_applied,close_quote_as_short,commit_blend_ticket_ocr_result,commit_label_draft,complete_cycle_count,complete_delivery,complete_job,compute_application_service_fee,compute_commission_amount,compute_fuel_surcharge_cents,compute_season,confirm_delivery,confirm_job_notification_sent,consolidate_draft_invoices,convert_quote_to_order,convert_to_gl_lb,correct_supplier_price_observation,create_application_record_from_blend_ticket,create_blend_ticket,create_commission_payment,create_delivery_with_items,create_direct_order,create_followup_delivery,create_inventory_hold,create_invoice_for_unbilled_delivery,create_invoice_from_blend_ticket,create_invoice_from_order,create_job_from_quote_section,create_label_draft,create_order_from_blend_ticket,create_planned_holds,create_prepay_check_splits,create_pricing_workbook_export,create_quick_delivery,create_quote_from_template,create_quote_version,create_rebate_claim,create_return,create_rush_order,create_split_invoices_from_order,create_vendor_bill,current_season,dashboard_summary,delete_invoices,delete_prepay_credit,delete_purchase_order,delete_vendor,derive_customer_shares_from_fields,dismiss_watchdog_flag,dispatch_job_locations,draw_down_quote,duplicate_quote,edit_delivery,edit_prepay_credit,enforce_blend_ticket_fields_billed_lock,enforce_blend_ticket_fields_downstream_lock,enforce_blend_ticket_products_billed_lock,enforce_delivery_accounting_period,enforce_field_application_type_lock,enforce_invoice_draft_on_insert,enforce_linked_blend_ticket_header_lock,enforce_linked_blend_ticket_product_lock,enforce_quote_accepted_fully_drawn,enforce_return_lifecycle_rpc_owned,enforce_return_source_immutable,execute_sql_readonly,field_app_priced_quantity,fields_acre_authority_guard,financial_dashboard_summary,find_overlapping_fields,generate_batch_statements,generate_finance_charges,generate_order_number,generate_quote_number,generate_rup_sales_records,generate_ticket_number,get_ap_aging,get_ap_dashboard_summary,get_ar_aging,get_ar_reminder_candidates,get_batch_year_end_summaries,get_booking_settlement,get_bottom_line_pnl,get_call_list_lapsed_products,get_call_list_no_recent_contact,get_call_list_prepay_prospects,get_call_list_stale_quotes,get_call_list_unassigned_accounts,get_chemical_history,get_commission_balance_report,get_customer_balance_listing,get_customer_delivery_remainders,get_customer_farm_group,get_customer_lapsed_products,get_customer_prep_card,get_customer_purchase_summary,get_customer_statement,get_customer_summary,get_customer_transaction_review,get_customer_year_end_summary,get_dashboard_action_items,get_detailed_statement_data,get_dispatch_board_jobs,get_dispatch_stock_status,get_dispatched_list,get_expiring_planned_holds,get_field_billing_splits_for_blend_ticket,get_field_billing_splits_for_order,get_field_dashboard,get_field_geojson,get_field_polygons,get_fields_geojson_by_ids,get_fields_with_geojson,get_gross_sales_report,get_inventory_cost_report,get_inventory_forecast,get_inventory_position,get_job_billed_customers,get_job_fields_with_geojson,get_job_inventory_shortfalls,get_job_proof_data,get_jobs_billed_customers,get_label_coverage_report,get_logbook_by_applicator,get_logbook_by_customer,get_logbook_by_field,get_logbook_faa,get_lot_application_trace,get_monthly_summary,get_notes_for_entity,get_offline_action_review_queue,get_offline_action_status,get_open_booking_rollover,get_product_price_history,get_program_completion,get_receiving_log,get_receiving_summary,get_recent_lots_for_product,get_rep_customer_purchase_flags,get_rup_sales_register,get_sales_detail_report,get_sales_summary_report,get_season_comparison,get_supplier_market_evidence,get_supplier_price_import,get_supplier_pricing_workspace,get_supplier_quote_sheet,get_team_board_deliveries,get_team_workload,get_watchdog_flags,get_yesterday_delivery_recap,global_search,guard_and_version_product_pricing,guard_audit_log_immutable,guard_completed_delivery_signature,guard_customer_document_update,guard_customer_fact_provenance,guard_interaction_attribution,guard_mono_invoice_split_billing_post,guard_quote_commission_split_valid,guard_split_invoice_provenance_identity,guard_split_invoice_provenance_items,guard_supplier_price_observation_immutable,handle_new_user,increment_customer_prepay,is_admin,is_applicator,is_driver,is_sales_rep,issue_return_credit,jobs_snapshot_commission_split,link_blend_ticket_to_order,link_fields_to_parent,load_recipe_into_job,log_comment_activity,log_customer_interaction,log_failed_notification,log_note_activity,manual_inventory_add,mark_inventory_row_verified,mark_overdue_invoices,match_quick_receive_items,next_application_record_number,next_commission_payment_number,next_cycle_count_number,next_delivery_number,next_invoice_number,next_job_number,next_po_number,next_return_number,normalize_phone_e164,normalize_product_category,normalize_rate_unit,normalize_vendor_alias,notify_damaged_receiving,notify_mentioned_users_in_comment,operational_dashboard_summary,parse_payment_terms_days,plpgsql_check_function,plpgsql_check_function_tb,plpgsql_check_pragma,plpgsql_check_profiler,plpgsql_check_tracer,plpgsql_coverage_branches,plpgsql_coverage_statements,plpgsql_profiler_function_statements_tb,plpgsql_profiler_function_tb,plpgsql_profiler_functions_all,plpgsql_profiler_install_fake_queryid_hook,plpgsql_profiler_remove_fake_queryid_hook,plpgsql_profiler_reset,plpgsql_profiler_reset_all,plpgsql_show_dependency_tb,post_commission_payment,post_invoice,post_invoice_group,prevent_oifa_edit_after_post,prevent_order_shares_edit_after_post,preview_field_app_invoice_split,preview_finance_charges,preview_product_pricing_changes,price_order,process_offline_action,product_price_per_acre,reassign_delivery,recalc_product_price_per_acre,receive_po_items,receive_return,recompute_job_applied_acres,reconcile_negative_inventory,reconcile_prepay_balances,record_invoice_payment,record_job_post_notifications,record_job_pre_notifications,record_vendor_payment,refresh_watchdog_flags,reject_return,release_expired_quote_holds,release_holds_on_quote_status_change,release_inventory_hold,reopen_accounting_period,require_admin,require_admin_or_sales_rep,require_governed_product_pricing,require_split_invoice_creation_claim,reserve_job_inventory,resolve_offline_action,restore_cancelled_delivery,restore_cancelled_order,restore_quote_version,retire_inventory_item,retry_failed_notifications,reverse_application_record,reverse_blend_ticket_approval,reverse_completed_cycle_count,reverse_credit_memo_application,reverse_receiving_record,reverse_write_off,revert_quote_status,review_customer_fact,review_vendor_alias,rollover_quote_to_season,run_data_integrity_sweep,run_morning_notification_checks,run_weekly_db_backup,safe_cents_qty,save_blend_recipe,save_blend_ticket,save_blend_ticket_fields,save_customer,save_field,save_field_app_invoice,save_field_crop_history,save_field_geometry,save_field_polygons,save_idempotency,save_invoice,save_job,save_job_applied_record,save_purchase_order,save_quote,save_quote_template,save_vendor,season_end_date,season_start_date,set_application_record_lots,set_field_boundary,set_field_override_acres,set_primary_customer_contact,set_supplier_evidence_updated_at,settle_applied_record_acres,snapshot_field_crop_history,stage_offline_action,stage_supplier_price_import,stage_vendor_alias,stamp_job_printed,start_job,submit_purchase_order,supersede_customer_fact,sync_blend_ticket_payment_status,sync_customer_to_primary_contact,sync_primary_contact_to_customer,touch_blend_ticket_product_parent_version,transfer_invoice_to_job,transfer_job_to_invoice,transition_rebate_claim,trg_delivery_status_change,trg_inventory_significant_change,trg_jarf_recompute,trg_job_applied_record_recompute,trg_order_status_change,trg_po_status_change,trg_po_submitted_update_on_order,trg_product_label_drafts_updated_at,trg_recalc_order_totals,unapply_credit_memo,undispatch_job_locations,unlink_blend_ticket_from_order,unlink_field_from_parent,unpost_invoice,unpost_invoice_group,update_blend_ticket_billing_status,update_blend_ticket_updated_at,update_cycle_count_item,update_field_app_applied_info,update_field_app_invoice_billing,update_fields_updated_at,update_note_comment_timestamp,update_order_items,update_updated_at,update_vendor_bill,upsert_product_supplier_link,validate_commission_split_json,validate_product_units,validate_supplier_price_observation_insert,vendor_bills_positive_subtotal_trigger,void_commission_payment,void_delivery,void_invoice,void_invoice_group,void_order,void_payment,void_vendor_bill,void_vendor_payment,write_product_pricing_history';

const LIVE_PG_PROC_COUNT = 470; // count(DISTINCT proname); FULL REGEN 2026-07-20 after governed split edit/group-void correction (ledger 20260720181939); exact CSV md5 73c1a96b186c9f9efb963886c6ff12b8. Includes trigger/helper and plpgsql_check extension functions in public. NOTE: the two flag-gated per-line-split RPCs (resolve_line_split_vector, save_field_app_split_invoice) from the checked-in-but-UNAPPLIED migration 20260718030000 remain in QUEUED_MIGRATION_FUNCTIONS below (verified absent-live) until that migration applies — then regenerate from live pg_proc and drop the queued entries.
...
const QUEUED_MIGRATION_FUNCTIONS: Record<string, string> = {
  // Per-line split billing (Codex round-3 P2): both are created by the checked-in but UNAPPLIED
  // migration below and are called by the FLAG-GATED split editor. The caller cannot fire until
  // per_line_split_billing_enabled is turned on, which happens only AFTER the migration applies —
  // so committing this bridge is deploy-safe. Remove both once the migration is live and the CSV
  // above is regenerated. Verified by the tests below: absent from live pg_proc + sourced here.
  resolve_line_split_vector: '20260718030000_per_line_split_billing_save_rpc.sql',
  save_field_app_split_invoice: '20260718030000_per_line_split_billing_save_rpc.sql',
};
const QUEUED_FUNCTIONS = new Set(Object.keys(QUEUED_MIGRATION_FUNCTIONS));

// The only functions permitted in the queued bridge above: the known FLAG-GATED parked split-billing
// RPCs. Any other queued entry is a mistake (a non-gated caller could hit a missing production RPC).
const ALLOWED_QUEUED_FUNCTIONS = new Set([
...
describe('Live pg_proc snapshot integrity', () => {
  ...
  it('queued RPC exceptions are limited to known flag-gated parked functions', () => {
    // A queued exception is only safe when the caller is FLAG-GATED — it cannot fire until the
    // feature flag is turned on, which happens only AFTER the migration applies — AND the entry is
    // removed at go-live once the CSV is regenerated from live pg_proc. Restrict the bridge to the
    // explicit ALLOWED_QUEUED_FUNCTIONS allowlist so an arbitrary caller for a non-existent RPC
    // (a non-gated deploy-order hazard) still fails the production-call test above (Codex round-3 P2).
    expect(Object.keys(QUEUED_MIGRATION_FUNCTIONS).filter((k) => !ALLOWED_QUEUED_FUNCTIONS.has(k))).toEqual([]);
  });
});
