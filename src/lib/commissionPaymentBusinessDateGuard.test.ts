...
const migration = readFileSync(
  'supabase/migrations/20260908120400_enforce_commission_payment_business_date.sql',
  'utf8',
).replace(/\r\n/g, '\n');
...
describe('commission payment Chicago business-date guard', () => {
  ...
  it('serializes the preflight and refuses an existing future-dated payment', () => {
    ...
    expect(attributes).toContain(
      'supabase/migrations/20260908120400_enforce_commission_payment_business_date.sql text eol=lf',
    );
  });
