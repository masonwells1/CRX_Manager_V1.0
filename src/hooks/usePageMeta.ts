...
const pageMeta: Record<string, { title: string; accent: string }> = {
  ...
  '/receiving': { title: 'Receiving', accent: 'Workspace' },
  ...
  '/label-data-quality': { title: 'Label Data', accent: 'Quality' },
  ...
  '/prepay': { title: 'Prepay', accent: 'Workspace' },
  '/integrity': { title: 'Data', accent: 'Integrity' },
